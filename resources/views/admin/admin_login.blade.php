                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <x-auth-session-status class="mb-4" :status="session('status')" />
                     <!-- Validation Errors -->
                     <x-auth-validation-errors class="mb-4" :errors="$errors" style="color:rgb(220 38 38)"/>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="password" name="password" class="form-control" id="password" autocomplete="current-password" placeholder="Password" required autocomplete="current-password">
                      </div>
